...
public class ReadExcelData
{
	...
	//public void readExcelData_GET(String module,String submodule,String testcaseid,String testdatasheet)
	public void readExcelData_GET(String module,String submodule,String testcaseid)
	{
		try {
			//Connection con=fillo.getConnection("testdata/"+testdatasheet);
		Connection con=fillo.getConnection("testdata/APITestData.xls");
		Recordset rs=null;
		boolean flag=false;
		     try {
		          rs=con.executeQuery("select * from GetRequest where Module='"+module+"' and Submodule='"+submodule+"' and TC='"+testcaseid+"'");
		          flag=true;
	...
	//public void readExcelData_POST(String module,String submodule,String testcaseid,String testdatasheet)
	...
	try {
		...
		Recordset rs=null;
		try {
		rs=con.executeQuery("select * from PostRequest where Module='"+module+"' and Submodule='"+submodule+"' and TC='"+testcaseid+"'");
	...
	//public void readExcelData_PUT(String module,String submodule,String testcaseid,String testdatasheet)
	public void readExcelData_PUT(String module,String submodule,String testcaseid)
	{
		...
		Recordset rs=null;
		try {
		    rs=con.executeQuery("select * from PutRequest where module='"+module+"' and submodule='"+submodule+"' and TC='"+testcaseid+"'");
	...
	//public void readExcelData_DELETE(String module,String submodule,String testcaseid,String testdatasheet)
	...
	//public void writeDataToExcel(String module,String submodule,String testcaseid,String httpmethod,String field,String value,String testdatasheet)
	public void writeDataToExcel(String module,String submodule,String testcaseid,String httpmethod,String field,String value)
	{
		...
		Connection con=null;
		//con=fillo.getConnection("testdata/testdatasheet");
		try { 
		if(httpmethod.equalsIgnoreCase("GET"))
		{
		 ...
		 for(int i=3;i<colcount;i=i+2)
		 {
			 ...
			 if(fieldname.equalsIgnoreCase(field))
			 {
				...
				// con.executeUpdate("Update GET Set "+fieldnm+"='"+value+"' where module='"+module+"' and submodule='"+submodule+"' and TC='"+testcaseid+"'");
		...
		else if(httpmethod.equalsIgnoreCase("PUT"))
		{
		 ...
		 for(int i=3;i<colcount;i=i+2)
		 {
			 ...
			 {
				 String fieldnm=colname.get(i+1);
				// con.executeUpdate("Update PUT Set "+fieldnm+"='"+value+"' where module='"+module+"' and submodule='"+submodule+"' and TC='"+testcaseid+"'");
				 con.executeUpdate("Update Sheet1 Set "+fieldnm+"='"+value+"' where module='"+module+"' and submodule='"+submodule+"' and TC='"+testcaseid+"'");
		...
		} catch (FilloException e)
	{
		...
		//public void readDataFor_GET(String module,String submodule,String testcaseid,String datasheet)
		public void readDataFor_GET(String module,String submodule,String testcaseid)
		{
			try {
				//Connection con=fillo.getConnection("testdata/"+datasheet);
			Connection con=fillo.getConnection("testdata/APITestData.xls");
			Recordset rs=null;
			boolean flag=false;
			     try {
		...
		//public void readDataFor_POST(String module,String submodule,String testcaseid,String datasheet)
		...
		//public void readDataFor_PUT(String module,String submodule,String testcaseid,String datasheet)
